...
import { FaAws, FaCode, FaReact } from "react-icons/fa";
...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      `A railway ticket reservation and queue management system which enables customers
  ...
  },
  {
    ...
    description:
      `A java programme based on OOP, to store, retrieve and manage Premier League
  ...
  },
  {
    title: "Emoscape",
    description:
      ` A mobile application for music recommendation based on emotion recognition with a dataset
